...
namespace Server
{
    ...
    public partial class G2C_EnterMap : pb::IMessage
    {
        ...
        private static readonly pb::FieldCodec<global::Server.UnitInfo> _repeated_units_codec
            = pb::FieldCodec.ForMessage(18, global::Server.UnitInfo.Parser);
        private pbc::RepeatedField<global::Server.UnitInfo> units_ = new pbc::RepeatedField<global::Server.UnitInfo>();
        /// <summary>
        /// 所有的unit
        /// </summary>
        public pbc::RepeatedField<global::Server.UnitInfo> Units
        {
            get { return units_; }
            set { units_ = value; }
        }
    ...
    public partial class M2C_CreateUnits : pb::IMessage
    {
        ...
        private static readonly pb::FieldCodec<global::Server.UnitInfo> _repeated_units_codec
            = pb::FieldCodec.ForMessage(10, global::Server.UnitInfo.Parser);
        private pbc::RepeatedField<global::Server.UnitInfo> units_ = new pbc::RepeatedField<global::Server.UnitInfo>();
        public pbc::RepeatedField<global::Server.UnitInfo> Units
        {
            get { return units_; }
